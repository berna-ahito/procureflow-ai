...
[![Backend Tests](https://img.shields.io/badge/backend-144%20tests-brightgreen?style=flat-square)](https://github.com/berna-ahito/procureflow-ai)
...
[![Frontend Tests](https://img.shields.io/badge/frontend-35%20tests-brightgreen?style=flat-square)](https://github.com/berna-ahito/procureflow-ai)
...
```bash
# Backend (144 passing, 95% coverage)
